...
import {
    ImageBoxProp,
    ImageBoxState,
    ImagePreviewDialogueProp,
    ImagePreviewDialogueState
} from '../../types/ImageTypes'
import { Spinner, Dialog } from '@blueprintjs/core'
import $ from 'jquery'
import { stat } from 'fs'

export class ImagePreviewDialogue extends React.Component<
    ImagePreviewDialogueProp,
    ImagePreviewDialogueState
> {
    ...
    componentDidUpdate = (
        prevProps: ImagePreviewDialogueProp,
        prevState: ImagePreviewDialogueState
    ) => {
                ...
                >
                    {
                        <img
                            src={this.props.src}
                            width={
                                this.props.src_width > this.props.src_height
                                    ? docWidth * 0.8
                                    : ''
                            }
                            height={
                                this.props.src_height > this.props.src_width
                                    ? docHeight * 0.8
                                    : ''
                            }
